...
mkdir ./jobs
cp -r ${repo_root}/jobs/* jobs
mkdir ./services
# git clone --branch feat/integration https://github.com/agerardin/aithena-services.git ./services/aithena-services
cp -r ${repo_root}/${tool_dir}/* ${tool_dir}
PYPROJECT_FILE="${tool_dir}/pyproject.toml"
# sed -i 's|{git = "https://github.com/agerardin/aithena-services.git", branch = "feat/integration", subdirectory = "chatbot-dash"}|{path="../../services/aithena-services/chatbot-dash", develop=true}|g' $PYPROJECT_FILE
