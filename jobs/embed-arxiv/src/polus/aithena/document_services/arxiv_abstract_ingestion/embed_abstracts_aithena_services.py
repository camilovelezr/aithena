...
from polus.aithena.document_services.arxiv_abstract_ingestion.embed.embed_aithena_services import (
    EmbedderAithenaServices,
)
...
def embed_abstracts_aithena_services(
    ...
    qdrant_db_tasks.register_arxiv_metadata_with_nomic768_embeddings(db, source_id)
    ...
    if inp_dir is not None:
        ...
        total_count = ingester.embed_arxiv_records_dir(
            ...
            embedder=EmbedderAithenaServices(max_workers=1),
