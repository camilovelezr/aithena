...
from polus.aithena.document_services.arxiv_abstract_ingestion.embed.embed_instructor_xl import (
    EmbedderInstructorXl,
)

logger = get_logger(__file__)


def embed_abstracts_instructorxl(
    ...
    qdrant_db_tasks.register_arxiv_metadata_with_instructorXL_embeddings(db, source_id)
    ...
    if inp_dir is not None:
        ...
        total_count = ingester.embed_arxiv_records_dir(
            ...
            embedder=EmbedderInstructorXl(config.MAX_WORKERS),
