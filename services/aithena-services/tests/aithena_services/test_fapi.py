...
@pytest.mark.skipif(not AZURE_OPENAI_ENDPOINT, reason="azure not available")
...
@pytest.mark.skipif(not OLLAMA_HOST, reason="ollama not available")
...
@pytest.mark.skipif(not AZURE_OPENAI_ENDPOINT, reason="openai not available")
